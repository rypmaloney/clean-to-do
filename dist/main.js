...
function addToList(){
    ...
    let formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.default)(new Date(date[0],date[1],date[2]),  "MMMM do" );

    let timeUntil = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.default)(new Date(date[0], date[1], date[2]),{ addSuffix: true } )
