...
function displayProjects(){
    ...
    for (let i = 0; i < _index_js__WEBPACK_IMPORTED_MODULE_1__.projects.length; i++) {
        ...
        projItem.innerHTML +=
            `<h3>${_index_js__WEBPACK_IMPORTED_MODULE_1__.projects[i].name}</h3>` +
            `<p>${_index_js__WEBPACK_IMPORTED_MODULE_1__.projects[i].list.length} items</p>`;
